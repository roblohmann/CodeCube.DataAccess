...
//{
//    public abstract class ApplicationDataContext : DbContext, IApplicationDataContext
//    {
//        private readonly Dictionary<Type, EntitySetBase> _mappingCache = new Dictionary<Type, EntitySetBase>();

//        #region constructor
//        protected ApplicationDataContext() : base("name=ApplicationConnectionstring")
//        {
//            InitEntityFrameworkConfiguration();
//        }

//        protected ApplicationDataContext(string connectionstring) : base(connectionstring)
//        {
//            InitEntityFrameworkConfiguration();
//        }
//        #endregion
...
//                            changedOrAddedItem.DateCreated = DateTimeHelper.DateTimeNow();
//                            changedOrAddedItem.DateModified = DateTimeHelper.DateTimeNow();
//                            break;
//                        case EntityState.Modified:
//                            changedOrAddedItem.DateModified = DateTimeHelper.DateTimeNow();
//                            break;
//                        case EntityState.Deleted:
//                            changedOrAddedItem.DateDeleted = DateTimeHelper.DateTimeNow();
//                            changedOrAddedItem.DateModified = DateTimeHelper.DateTimeNow();
...
//                {
//                    outputLines.Add($"{DateTimeHelper.DateTimeNow()}: Entity of type \"{eve.Entry.Entity.GetType().Name}\" in state \"{eve.Entry.State}\" has the following validation errors:");
