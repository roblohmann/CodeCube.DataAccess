namespace CodeCube.DataAccess.EntityFrameworkCore.Sql.Constants
{
    public static class ErrorConstants
    {
        ...
        public const string AppSettingsBaseDirectoryNotFoundRecursively ="Basedirectory for 'appsettings.json' could not be determined! Paths have recusively been checked!";
    }
}
